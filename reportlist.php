        ...
        <nav class="navbar navbar-default " role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="patient.php"><!-- <img alt="Brand" src="assets/img/logo.png" height="40px"> -->
                        Manmohan Memorial Communty Hospital
                    </a>
                </div>
...
echo "<div class='panel-heading'>Print your Report from here !!!</div>";
...
echo "<td><a href='report.php?appid=".$userRow['appId']."' target='_blank'><span class='glyphicon glyphicon-print' aria-hidden='true'></span></a> </td>";
}
