		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php">Manmohan Memorial Community Hospital</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>">Tests</a></li>
						...
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								...
								<div class="description">
									...
									<hr />
									<!-- <button type="button" href="patientupdateprofile.php" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Update Profile</button> -->
								</div>
							</div>
						</div>
